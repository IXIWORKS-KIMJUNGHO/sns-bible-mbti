...
class BiblicalCharacters {
  static final List<BiblicalCharacter> characters = [
    ...
    BiblicalCharacter(
      ...
      englishName: 'Mary',
      title: '향유옥합을 깨뜨린 자',
      description: '값비싼 향유를 예수님께 부어 헌신과 사랑을 보여준 베다니의 마리아',
      mainEvents: ['예수님 발에 향유를 부음', '머리털로 발을 닦음', '향유옥합을 깨뜨림', '예수님께 헌신적 사랑'],
      behaviorPatterns: ['온전한 헌신', '희생적 사랑', '깊은 경배', '과감한 표현'],
      imageAsset: 'assets/images/characters/mary.png',
      traits: ['헌신적', '경배', '희생적사랑', '온유함', '진정성'],
      strengths: ['온전한 헌신', '순수한 사랑', '깊은 경배'],
      growthAreas: ['현실적 균형', '타인의 시선 신경쓰지 않기', '자기 돌봄'],
      bibleVerse: '이 여자가 내 몸에 이 향유를 부은 것은 내 장례를 위하여 함이니라',
      verseReference: '마태복음 26:12',
      colorTheme: 'teal',
    ),
